...
import 'package:katalog_movie/bloc/get_movie_detail_bloc.dart';
import 'package:katalog_movie/model/movie_detail.dart';
                    ...
                    return Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                width: 1.0, color: Color(0xFF3C46FC))),
                        child: Text(
                          detail.genres[index].name,
                          maxLines: 2,
                          style: TextStyle(
                              height: 1.4, color: Colors.white, fontSize: 9.0),
                        ),
                      ),
                    );
                  },
